...
### Check replication on the slave. It's working
...
### Start a slow query replication
...
`
### Drop the middle column for the slave. Replication doesn't work for the slave with a deleted column
...
### Drop the last column. Everything works ok
